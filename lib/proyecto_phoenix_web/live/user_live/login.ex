defmodule ProyectoPhoenixWeb.UserLive.Login do
        ...
        <div class="text-center">
          <.header>
            ...
            <:subtitle>
              ...
              <% else %>
                Aún no tinees cuenta?<.link
                  navigate={~p"/users/register"}
                  class="font-semibold text-brand hover:underline"
                  phx-no-format
                >Registrate</.link> para tener una cuenta.
              <% end %>
            </:subtitle>
          </.header>
        </div>
  ...
  defp local_mail_adapter? do
    Application.get_env(:proyecto_phoenix, ProyectoPhoenix.Mailer)[:adapter] == Swoosh.Adapters.Local
  end
end
